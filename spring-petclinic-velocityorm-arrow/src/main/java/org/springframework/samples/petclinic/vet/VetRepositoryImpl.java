...
import com.velocityorm.arrow.VelocityArrow;
import com.velocityorm.arrow.ArrowRepository;
...
public class VetRepositoryImpl implements VetRepository {
	...
	@Override
	public byte[] findAllAsArrowIPC() throws Exception {
		ArrowRepository<Vet, Integer> arrowRepo = VelocityArrow.repository(orm, Vet.class);
		return arrowRepo.findAllAsArrowIPC();
	}
